...
// $media->progress = $possible_location[1];
	...
	public function do_bootstrap($opts) {
		...
		if ((!class_exists('UDP_Google_Config') || !class_exists('UDP_Google_Client') || !class_exists('Google_Service_Storage') || !class_exists('Google_Http_Request')) && !function_exists('google_api_php_client_autoload_updraftplus')) {
